                        ...
                        <div className="relative bg-gray-900 rounded-[3rem] p-3 shadow-2xl">
                            ...
                            <div className="relative bg-white rounded-[2.5rem] overflow-hidden w-[375px] h-[750px]">
                                <div className="h-full overflow-y-auto bg-white">
                                    ...
                                    <div className="bg-white font-serif w-full pb-20">
                                            ...
                                            <div className="relative w-full min-h-[500px] flex items-end pb-16 overflow-hidden">
                                                ...
                                                <div className="relative z-10 w-full px-4 pt-20">
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full text-2xl font-serif font-black text-white leading-[1.2] mb-4 tracking-tight drop-shadow-lg bg-transparent border-none focus:ring-0 focus:outline-none p-0 resize-none overflow-hidden placeholder-white/50 min-h-[40px]"
                                                    ...
                                                    <textarea
                                                        ...
                                                        className="w-full text-sm text-gray-200 font-sans font-light leading-relaxed mb-6 drop-shadow-md bg-transparent border-none focus:ring-0 focus:outline-none p-0 resize-none overflow-hidden placeholder-gray-400 min-h-[30px]"
                                                        ...
                                                        {article.keyTakeaways.map((item, index) => (
                                                            <li key={index} className="flex items-start gap-2 text-gray-800 font-sans text-xs leading-relaxed">
                                                                ...
                                                                <div className="w-full">
                                                                    ...
                                                                    <textarea value={item.content} onChange={(e) => { updateKeyTakeaway(index, 'content', e.target.value); autoResize(e.target); }} className="w-full bg-transparent border-none focus:ring-0 focus:outline-none p-0 resize-none overflow-hidden text-gray-800 text-xs" rows={1} placeholder="Content" />
                                                                </div>
                                                            </li>
                                                        ))}
                                                    </ul>
